...
o których chcemy wnioskować.
Będziemy rozważać jedynie spójne sterty, a
ponieważ język Jafun jest silnie typowany, więc potrzebne
...
\begin{theorem}[O poprawności logiki separacji dla języka Jafun]{\ } \\
  ...
  na stercie $h$, jeśli  $\[ P \]_{h, env} = \top$, to również $\[ Q \]_{h, env} = \top$.
  \qed
\end{theorem}
...
Pełen dowód tego twierdzenia w systemie Coq znajduje się w pliku \texttt{JaIrisSoundeness.v}
