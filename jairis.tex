...
Dla wygody każda ramka stosu jest podzielona na kontekst $C_i \in \BCtxt$ i redeks $E_i$.
Kontekst $C_i$ opisuje wszystkie zagnieżdżone bloki $\jlet$ i $\jcatch$, wewnątrz którch znajduje się $E_i$.
